...
static void gen_ran_mat(int **mat)
{
  printf("gen_ran_mat\n");
}

static void make_mat_from_file(int **mat)
{
  printf("make_mat_from_file\n");
}
...
static void play_manual(int **mat)
{
  printf("play_manual\n");
}

static void play_auto(int **mat)
{
  printf("play_auto\n");
}
